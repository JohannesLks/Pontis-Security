<template>
  <section id="contact" class="bg-white dark:bg-gray-900 py-16 flex items-center justify-center min-h-screen">
    <div class="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
      <!-- Karte/Adresse (keine Änderung nötig) -->
      <div class="lg:w-2/3 md:w-1/2 bg-blue-300 dark:bg-gray-800 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
        ...
        <div class="bg-white dark:bg-gray-700 relative flex flex-wrap py-6 rounded shadow-md">
          ...
          <div class="lg:w-1/2 px-6 mt-4 lg:mt-0">
            ...
            <a
              href="mailto:web@pontis-security.com"
              class="text-primary dark:text-red-pontis leading-relaxed"
              >web@pontis-security.com</a
            >
      ...
      >
        ...
        <div class="relative w-full bg-gray-300 dark:bg-gray-700 rounded-full h-4 mb-4">
          <div
            ...
            class="bg-primary dark:bg-pontis-red h-full rounded-full transition-all duration-300"
          >
            <span
              :style="{ color: progress > 0 ? 'white' : '#B32222' }"
        ...
        <form @submit.prevent="onSubmit" class="space-y-4">
          ...
          <button
            type="submit"
            class="text-white bg-primary dark:bg-red-pontis border-0 py-3 px-6 focus:outline-none hover:bg-red-pontis-hover dark:hover:bg-red-pontis-hover rounded text-lg w-full transition-colors duration-200 ease-in-out flex items-center justify-center"
            :disabled="isLoading"
          >
            <!-- Ladekreis, wenn isLoading true ist -->
            <svg
              v-if="isLoading"
        ...
        <!-- Fehlermeldung für Server-Fehler -->
...
export default {
  ...
  data() {
    return {
      ...
      // Neu hinzugefügt: isLoading steuert, ob der Spinner angezeigt wird
      isLoading: false,
    ...
    async onSubmit() {
      ...
      try {
        ...
        if (response.data.success) {
          ...
          // Beispiel: Weiterleitung nach Erfolg (wenn gewünscht)
        ...
        // Spinner ausschalten, egal ob Erfolg oder Fehler
